...
import imgs from "./images/headphone.png";
          ...
          <div className="flex flex-col space-y-6 ">
            ...
            <div className="mb-4 flex flex-col space-y-3 text-center md:text-left">
              ...
              <div className="max-w-sm  text-2xl font-medium">
                Razer Kraken Kitty Edt Gaming Headset Quart
              </div>
              <div className="mb-4 flex flex-col space-y-3 text-center md:text-left ">
              ...
              {/* Button Group */}
              <div className="group">
                <button className="w-full rounded-lg border-b-8 border-b-blue-700 bg-blue-700 text-white transition-all duration-150 group-hover:border-b-0 group-hover:border-t-8 group-hover:border-t-blue-700 group-hover:bg-blue-700 group-hover:drop-shadow-lg">
